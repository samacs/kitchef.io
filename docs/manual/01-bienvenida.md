...
![La pantalla Inicio con el resumen de la semana, los pedidos de hoy y tu menú](images/01-bienvenida--inicio.png)
...
![El formulario de "Agregar platillo" con campos para nombre, precio y categoría](images/01-bienvenida--primer-platillo.png)
